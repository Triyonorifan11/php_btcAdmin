            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="height: 90vh; ">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close text-lg py-3 opacity-10" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body" style="overflow-y:scroll ;">
                        <form class="" method="GET">
                            ...
                            <section class="col-12 d-flex">
                                <div class="mb-3 ms-md-auto pe-md-3 input-group input-group-outline ">
                                    <input type="hidden" name="halaman" value="1">
                                    <span class="form-label" id="addon-wrapping"></span>
                                    <input type="date" class="form-control" name="start_date" value="<?= $_GET['start_date']; ?>">
                                </div>
                                <div class="mb-3 ms-md-auto input-group input-group-outline">
                                    <span class="form-label" id="addon-wrapping"></span>
                            ...
                            <section class="col-12 d-flex">
                                <select class="form-select select-group select-group-outline" aria-label="Default select example" name="level">
                            ...
                            <section class="col-12 d-flex">
                                <div class="mb-3 ms-md-auto pe-md-3 input-group input-group-outline">
                                    <select class="form-select select-group select-group-outline" aria-label="Default select example" name="start_sinyal">
                                        <span class="form-label" id="addon-wrapping"></span>
                                ...
                                <div class="mb-3 ms-md-auto input-group input-group-outline">
                                    <select class="form-select select-group select-group-outline" aria-label="Default select example" name="end_sinyal">
                                        <span class="form-label" id="addon-wrapping"></span>
                            ...
                            <section class="col-12 d-flex">
                                <div class="mb-3 ms-md-auto pe-md-3 input-group input-group-outline">
                                    <span class="form-label" id="addon-wrapping">from Rp</span>
                                    <input type="number" class="form-control" name="start_harga_idr" value="<?= $_GET['start_harga_idr']; ?>">
                                </div>

                                <div class="mb-3 ms-md-auto input-group input-group-outline">
                                    <span class="form-label" id="addon-wrapping">to Rp</span>
                            ...
                            <section class="col-12 d-flex">
                                <div class="mb-3 ms-md-auto pe-md-3 input-group input-group-outline">
                                    <span class="form-label" id="addon-wrapping">from $</span>
                                    <input type="number" class="form-control" name="start_harga_usd" value="<?= $_GET['start_harga_usd']; ?>">
                                </div>

                                <div class="mb-3 ms-md-auto input-group input-group-outline ">
                                    <span class="form-label" id="addon-wrapping">to $</span>
                            ...
                            <section class="col-12 d-flex">
                                ...
                                <div class="mb-3 mx-1 ms-md-auto input-group input-group-outline">
                                    <span class="form-label" id="addon-wrapping">to $</span>
        ...
        <form action="" method="GET" class="d-flex flex-column col-lg-3 col-md-6 col-sm-12 position-relative">
            <!-- <div class="row">
                <div class="col-12 d-flex">
                    <div class="ms-md-auto pe-md-3 input-group input-group-outline">
                        <label class="form-label"></label>
                        <input type="text" class="form-control me-3" id="keysearch" name="keysearch" size="3" autofocus aria-label="Search" autocomplete="off">
                    </div>
            ...
            <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                <div class="input-group input-group-outline">
                    <label class="form-label"><?= isset($_GET['id']) ? "id = " . $_GET['id'] : "Cari id/level/jenis"; ?></label>
                    <input type="text" class="form-control" id="keysearch" name="keysearch" autofocus aria-label="Search" autocomplete="off">
                </div>
            </div>
