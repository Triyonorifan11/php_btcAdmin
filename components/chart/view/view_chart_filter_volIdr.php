    ...
    <div class="card">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-warning shadow-warning border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Chart Filter by Volume IDR & Date Picker</h6>
        ...
        <div class="card-body">
                ...
                <form action="" method="get">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-4">
                            ...
                            <a href="http://localhost:1109/pemWeb/btcAdmin/chart4.php" class="btn btn-danger me-auto mb-3"><i class="bi bi-arrow-clockwise"></i> Reset</a>
                        </div>
                    </div>
            ...
            <div>
                <canvas id="chart_vol_idr"></canvas>
            </div>
        </div>
    </div>
</div>